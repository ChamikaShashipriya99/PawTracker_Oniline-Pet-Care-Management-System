...
function AdminDashboard() {
  ...
  const handleDownloadAllPDF = () => {
    ...
    logoImg.onload = function() {
      ...
      doc.text('PawTracker Admin Report', 105, yOffset, { align: 'center' });
      
      // Add date
      doc.setFontSize(12);
      doc.setTextColor(85, 85, 85);
      doc.text(`Generated on: ${new Date().toLocaleDateString()}`, 105, yOffset + 10, { align: 'center' });
      
      // Add user statistics
      doc.setFontSize(16);
      doc.setTextColor(0, 123, 255);
      doc.text('User Statistics', 20, yOffset + 25);
      
      // Add user counts
      doc.setFontSize(12);
      doc.setTextColor(85, 85, 85);
      doc.text(`Total Users: ${userCount}`, 20, yOffset + 35);
      doc.text(`Total Admins: ${adminCount}`, 20, yOffset + 42);
      
      // Add user list
      doc.setFontSize(16);
      doc.setTextColor(0, 123, 255);
      doc.text('All Users', 20, yOffset + 60);
  ...
  const handleDownloadSearchResultsPDF = () => {
    ...
    logoImg.onload = function() {
      ...
      doc.setFontSize(12);
      doc.setTextColor(85, 85, 85);
      doc.text('Search Results', 105, yOffset + 10, { align: 'center' });
      
      // Add search term and date
      doc.setFontSize(10);
      doc.text(`Search Term: ${searchTerm}`, 14, yOffset + 20);
      doc.text(`Generated on: ${new Date().toLocaleDateString()}`, 14, yOffset + 25);
                        ...
                        <button
                          onClick={() => {
                            ...
                            logoImg.onload = function() {
                              ...
                              doc.setFontSize(24);
                              doc.setTextColor(0, 123, 255);
                              doc.text('PawTracker User List', 105, yOffset, { align: 'center' });
                        ...
                        <button
                          onClick={() => {
                            ...
                            logoImg.onload = function() {
                              ...
                              doc.setFontSize(24);
                              doc.setTextColor(255, 87, 51);
                              doc.text('PawTracker Admin Search Results', 105, yOffset, { align: 'center' });
                        ...
                        <button
                          onClick={() => {
                            ...
                            logoImg.onload = function() {
                              ...
                              doc.setFontSize(24);
                              doc.setTextColor(255, 87, 51);
                              doc.text('PawTracker Admin List', 105, yOffset, { align: 'center' });
