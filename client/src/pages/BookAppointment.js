        ...
        <div className="appointment-container">
            ...
            <form className="appointment-form" onSubmit={handleSubmit}>
                <div className="form-group">
                    ...
                    />
                    {errors.petOwner && <span className="error" style={{ color: 'red' }}>{errors.petOwner}</span>}
                </div>
                ...
                <div className="form-group">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                    />
                    {errors.petName && <span className="error" style={{ color: 'red' }}>{errors.petName}</span>}
                </div>
                ...
                <div className="form-group">
                    ...
                    {errors.serviceType && <span className="error" style={{ color: 'red' }}>{errors.serviceType}</span>}
                </div>
