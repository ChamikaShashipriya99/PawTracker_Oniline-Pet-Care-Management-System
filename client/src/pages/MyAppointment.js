    ...
    return (
        <div className="appointment-container">
            ...
            {loading ? (
                ...
                <>
                    <div className="appointment-count" style={{ marginBottom: '20px', fontSize: '1.2rem', fontWeight: 'bold' }}>
                                        ...
                                        <tr key={appointment._id}>
                                            ...
                                            <td>
                                                <div className="action-buttons">
                                                    <button className="view-button" onClick={() => handleViewAppointment(appointment._id)}>
                                                        View
                                                    </button>
                                                    {appointment.status === 'Pending' && (
                                                        <>
                                                            <button className="edit-button" onClick={() => handleEditAppointment(appointment._id)}>
                                                                Edit
                                                            </button>
                                                    ...
                                                    {appointment.status === 'Approved' && (
                                                        <button className="pay-button" onClick={() => handleProceedToPay(appointment)}>
                                                            Proceed to Pay
                                                        </button>
                                                    )}
                                                    <button className="download-button" onClick={() => downloadPDF(appointment)}>
                                                        Download PDF
                                                    </button>
                                                </div>
                                            </td>
